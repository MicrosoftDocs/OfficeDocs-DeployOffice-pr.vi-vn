...
> [!NOTE]
> Để biết thông tin về các cài đặt tương tự đối với Office trên máy tính chạy Windows, hãy xem mục [ Sử dụng cài đặt chính sách để quản lý các biện pháp kiểm soát quyền riêng tư cho Office 365 ProPlus](manage-privacy-controls.md)
...
> [!NOTE]
> Nếu bạn đặt tùy chọn này, tùy chọn này cũng sẽ áp dụng cho các sản phẩm sau đây:
> - Teams for Mac phiên bản 1.00.217856 trở lên
> - Skype for Business for Mac phiên bản 16.28 trở lên
...
Đối với những người dùng khác, chẳng hạn như người dùng gia đình có đăng ký Office 365 thì chỉ có dữ liệu chẩn đoán bắt buộc mới được gửi đi, trừ khi người dùng cũng chọn gửi cả dữ liệu chẩn đoán tùy chọn bằng cách vào mục **Tùy chọn** > **Quyền riêng tư**.
